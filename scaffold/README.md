...
Use one canonical physical home for each doc. Use generated views like `IDEAS.md`, `SPECS.md`, `AREAS.md`, `DOCS-REGISTRY.md`, `TODOS.md`, and `HEALTH.md` for cross-cutting navigation instead of duplicating files.
